...
- **Hierarchy comes from size and weight, not a second typeface.** Display moments (a headline, a cover title) are Inter Medium 500 at a large size, elegant not heavy. Body and labels are Inter 400 / 500.
