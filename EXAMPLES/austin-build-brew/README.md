...
**Phase 2 · Preview → iterate (Gate 2).** Built on the Paper canvas and reviewed before export. The
magic trick: the cover and invite lead with the candid, arms-up, actually-laughing photos, not the
posed line-up.
